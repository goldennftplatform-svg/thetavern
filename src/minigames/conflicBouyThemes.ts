...
export const CHARTER_THEME: BouyTheme = {
  ...
  sunkGlow: "#e86058",
  textPrimary: "#f8f0ff",
  textSecondary: "#98b8e8",
  textMuted: "rgba(248, 240, 255, 0.4)",
  gold: "#e8b050",
  shipColors: {
    carrier: { main: "#e8b050", light: "#f8e0a0", dark: "#a87830" },
    battleship: { main: "#98b8e8", light: "#c8e0f8", dark: "#5878a8" },
    cruiser: { main: "#78d0b8", light: "#a8f0e0", dark: "#489078" },
    submarine: { main: "#e87850", light: "#f8b0a0", dark: "#a84830" },
    destroyer: { main: "#d8a868", light: "#f0d0a0", dark: "#987840" },
  },
  terms: {
